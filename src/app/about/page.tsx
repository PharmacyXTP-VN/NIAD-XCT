    ...
    return (
        <>
            ...
            <PageBanner 
                pageName="about" 
                title="Về NIAD" 
                subtitle="Đối tác tin cậy trong lĩnh vực dịch vụ, vận tải và cung cấp giải pháp cho ngân hàng, doanh nghiệp." 
            />
            <div
                        ...
                        {aboutBlocks.map((block, idx) => (
                            ...
                            >
                                <div className="w-full md:w-1/2 flex flex-col items-center justify-center">
                                    <div className="w-full flex items-center justify-center bg-[#f0f2f5] rounded-2xl h-[48vw] max-h-[380px] min-h-[180px] md:h-[380px]"
                                        style={{ transition: 'height 0.2s' }}>
                                        <AboutImages 
                                            imageIndex={idx} 
                                            className="rounded-2xl w-auto h-full max-w-full max-h-full"
                                        />
                                    </div>
                                    {idx === 0 && (
                                        <div className="grid grid-cols-3 gap-4 mt-6 w-full max-w-[400px]">
                                            <div className="bg-[#e6f9f0] rounded-xl p-4 text-center shadow">
                                                <div className="text-2xl font-bold text-[#006b68] mb-1">500 tỷ</div>
                                                <div className="text-[#1d1d1f] text-sm">Vốn điều lệ</div>
                                            </div>
                                            <div className="bg-[#e6f9f0] rounded-xl p-4 text-center shadow">
                                                <div className="text-2xl font-bold text-[#006b68] mb-1">2007</div>
                                                <div className="text-[#1d1d1f] text-sm">Năm thành lập</div>
                                            </div>
                                            <div className="bg-[#e6f9f0] rounded-xl p-4 text-center shadow">
                                                <div className="text-2xl font-bold text-[#006b68] mb-1">7+</div>
                                    ...
                                    {idx === 1 && (
                                        <div className="mt-6 bg-[#e6f9f0] rounded-xl p-6 shadow text-center w-full max-w-[500px]">
                                            <div className="text-xl font-semibold text-[#006b68] mb-2">
                                ...
                                <div className="w-full md:w-1/2 flex flex-col justify-center min-h-[320px] md:min-h-[380px]">
                                    <h2 className="text-3xl font-extrabold mb-4 text-[#006b68] tracking-tight">
                                        {block.title}
                                    </h2>
