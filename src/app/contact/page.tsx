    ...
    <DefaultLayout>
      ...
      <div className="min-h-screen bg-[#f7f7fa]">
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Info */}
          <div className="flex flex-col gap-8 items-center md:items-start max-w-3xl">
            <div className="flex flex-col gap-2">
              ...
              <div className="text-gray-800 text-base">
                <div className="mb-2">
                  <span className="font-semibold">Địa chỉ:</span> Tầng 6 số 263
                  đường Cầu Giấy,
                  <br /> P. Dịch Vọng, Q. Cầu Giấy, Hà Nội
                </div>
                <div className="mb-2">
            ...
            <div className="w-full flex flex-col gap-3">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-[#17877b] hover:text-white text-[#17877b] transition"
                >
                  <svg
                    width="22"
                    height="22"
