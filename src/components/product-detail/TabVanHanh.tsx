export default function TabVanHanh({ product }: { product: any }) {
  return (
    <section className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div className="flex items-center justify-center">
        <img src={product.gallery[3]} alt="An toàn" width={500} height={320} className="rounded-2xl shadow-xl object-contain" />
      </div>
