  ...
  return (
    <section className="w-full min-h-screen py-20 flex flex-col items-center justify-center bg-[#f0f2f5]">
      <div className="max-w-xl w-full flex flex-col items-center justify-center gap-4">
        ...
        <h2 className="text-3xl md:text-4xl font-bold drop-shadow text-[#03bb65] text-center">Đang tải dữ liệu...</h2>
        <p className="text-lg md:text-xl text-[#03bb65] text-center">Vui lòng chờ trong giây lát</p>
      </div>
    </section>
  );
} 